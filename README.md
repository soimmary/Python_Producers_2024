...
| 2 марта ✅| Тема 6. Неупорядоченные типы данных. Тема 7. Вложенные структуры данных, сортировки| Множества и словари||
| 11 марта ✅| Контрольная работа| ||
| 16 марта ✅| Тема 8. Функции. Тема 9. Текстовые файлы и таблицы| Функции. Файлы|СР (функции, файлы)|
...
**Критерии проекта:** https://docs.google.com/document/d/1xG5e_RtetyIdvDxO0r4wg0WexQ5xgf8-LPD9RIwpak0
