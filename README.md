...
| 17 февраля| Тема 6. Неупорядоченные типы данных. Тема 7. Вложенные структуры данных, сортировки| Множества и словари||
| 2 марта| Тема 8. Функции| Функции|СР (цикл for, методы)|
