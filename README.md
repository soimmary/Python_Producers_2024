...
| 17 февраля| Тема 6. Неупорядоченные типы данных. Тема 7. Вложенные структуры данных, сортировки| Множества и словари|СР (цикл for, методы)|
| 4 марта| Контрольная работа| ||
| 2 марта| Тема 8. Функции| Функции||
